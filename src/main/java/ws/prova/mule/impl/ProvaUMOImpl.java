	...
	public void send(String receiver, ProvaList provaList) throws Exception {
		...
		try {
			...
			if (receiver.equalsIgnoreCase("httpEndpoint")){
				...
				HttpEndpointUMOImpl.communicators.get("httpEndpoint").addMsg(provaList);
...
//				setTagTrue();
	...
	private void setTagTrue() throws IOException {

		 String trueFile = "D:\\true.txt";

		String falseFile = "D:\\false.txt";
		    ...
		    if (!success) {
		    	...
		    	System.out.println("Changing the file to 'true' succeed." + new Date().toGMTString());
